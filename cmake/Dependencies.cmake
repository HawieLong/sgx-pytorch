...
if(NOT INTERN_BUILD_MOBILE)
  ...
  if(USE_MKLDNN)
    ...
    if(MKLDNN_FOUND)
      ...
      include_directories("${PROJECT_SOURCE_DIR}/enclave_ops/ideep-enclave/App")
      include_directories("$ENV{SGX_SDK}/include")
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -lsgx_urts")
      set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -DENCLAVE_PATH=\\\"${PROJECT_SOURCE_DIR}/enclave_ops/ideep-enclave/libenclave.signed.so\\\"")
      if(BUILD_CAFFE2_OPS)
